...
class RegisterSessionMapItemsGenerator extends Generator {
  @override
  String generate(LibraryReader library, BuildStep buildStep) {
    ...
    for(var element in library.classes) {
      ...
      var isSessionMapItem = false;
      for(var interfaceType in element.allSupertypes) {
        if(interfaceType.getDisplayString() == 'SessionMapItem') isSessionMapItem = true;
      }
      if(!isSessionMapItem) continue;
